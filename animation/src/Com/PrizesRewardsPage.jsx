...
const TiltCard = () => {
  ...
  return (
    <div
      ...
      className="w-[320px] sm:w-[380px] md:w-[420px] z-50 h-[200px] sm:h-[230px] md:h-[260px] rounded-xl sm:rounded-2xl cursor-pointer flex items-center justify-center text-white relative overflow-hidden backdrop-blur-sm mx-4"
    >
      ...
      <div className="flex z-50 items-center space-x-3 sm:space-x-4 md:space-x-6 relative">
        ...
        <div className="text-right">
          ...
          <div className="text-xs sm:text-sm text-gray-300 mt-1 tracking-widest uppercase opacity-80">
            Seven Lakhs
          </div>
        </div>
      </div>
