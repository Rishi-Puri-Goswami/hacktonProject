  ...
  return (
    <div className='relative'>
      <div
        ...
        <div className='absolute md:top-0 lg:top-0 sm:top-[0px] top-14 h-10 lg:text-5xl md:text-5xl sm:text-3xl text-2xl w-full flex justify-center md:justify-end items-center z-50 font-loadfont'>
          <Timer />
        </div>

        <div className="absolute top-4 left-[-9px] md:h-[10vh] sm:h-[6vh] h-[5vh] z-50 ml-7">
          <img
            src={logo}
            alt="logo"
      ...
      <motion.div
        ...
        className="absolute bottom-0 left-0 right-0 z-[100] h-16" // <-- smaller height
        style={{
          background:
            "linear-gradient(90deg, rgba(20,30,70,0.95) 0%, rgba(30,60,120,0.9) 50%, rgba(10,20,50,0.95) 100%)",
          boxShadow:
            "0 -4px 20px rgba(30,60,120,0.4), 0 -8px 40px rgba(20,30,70,0.3)",
      ...
      >
        <div className="relative h-full flex items-center overflow-hidden">
          <motion.div
            ...
            className="flex items-center space-x-16 px-6 whitespace-nowrap"
          >
            {Array.from({ length: 10 }).map((_, i) => (
              ...
              >
                🚨 Registration is closing soon! Last date: 30th September 🚨
              </span>
            ))}
          </motion.div>
        </div>
