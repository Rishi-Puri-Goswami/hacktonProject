...
const Name = () => {
  ...
  className="flex absolute leading-tight tracking-tighter font-semibold justify-center font-loadfont 
    text-[10vw] sm:text-[8vw] md:text-[6vw] lg:text-[88px]
...
>
  ...
  <span className="ml-4 bg-clip-text text-transparent bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-600">
    4.0
  </span>
</div>
    </div>
